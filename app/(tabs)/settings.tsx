    ...
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.profileContainer}>
        ...
        <View style={styles.profileInfoContainer}>
          <Text style={styles.profileLabel}>Nickname : <Text style={styles.profileValue}>KK</Text></Text>
          <Text style={styles.profileLabel}>Email ID : <Text style={styles.profileValue}>abc@gmail.com</Text></Text>
          <Text style={styles.profileLabel}>Total tasks completed : <Text style={styles.profileValue}>99</Text></Text>
        </View>
      </View>
